...
//    	    }
	...
	public ResponseEntity<WithdrawalRequest> updateWithdrawalRequest(@PathVariable long requestId,
			@RequestBody WithdrawalRequest withdrawalRequest) {
		WithdrawalRequest updatedRequest = withdrawalRequestService.updateWithdrawalRequest(requestId,
				withdrawalRequest);
