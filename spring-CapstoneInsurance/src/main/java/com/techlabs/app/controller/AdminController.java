...
import com.techlabs.app.service.TaxSettingService;
...
//    	    ) {
//    	        return adminService.searchCities(id, name, sortField, sortOrder);
//    	    }
...
//    	    }
    	    ...
    	    public ResponseEntity<TaxSetting> createTaxSetting(@RequestBody TaxSetting taxSetting) {
    	        TaxSetting createdTaxSetting = taxSettingService.createTaxSetting(taxSetting);
    	        return ResponseEntity.ok(createdTaxSetting);
    	    }

    	    @PutMapping("/tax-settings/{taxId}")
    	    public ResponseEntity<TaxSetting> updateTaxSetting(@PathVariable long taxId, @RequestBody TaxSetting taxSetting) {
    	        TaxSetting updatedTaxSetting = taxSettingService.updateTaxSetting(taxId, taxSetting);
    	        return ResponseEntity.ok(updatedTaxSetting);
    	    }

    	    @DeleteMapping("/tax-settings/{taxId}")
    	    public ResponseEntity<Void> deleteTaxSetting(@PathVariable long taxId) {
    	        taxSettingService.deleteTaxSetting(taxId);
    	        return ResponseEntity.noContent().build();
    	    }

    	    @GetMapping("/tax-settings/{taxId}")
    	    public ResponseEntity<TaxSetting> getTaxSettingById(@PathVariable long taxId) {
    	        TaxSetting taxSetting = taxSettingService.getTaxSettingById(taxId);
    	        return ResponseEntity.ok(taxSetting);
    	    }

    	    @GetMapping("/tax-settings")
    	    public ResponseEntity<List<TaxSetting>> getAllTaxSettings() {
    	        List<TaxSetting> taxSettings = taxSettingService.getAllTaxSettings();
    	    ...
    	    public ResponseEntity<WithdrawalRequest> createWithdrawalRequest(@RequestBody WithdrawalRequest withdrawalRequest) {
    	        WithdrawalRequest createdRequest = withdrawalRequestService.createWithdrawalRequest(withdrawalRequest);
    	        return ResponseEntity.ok(createdRequest);
    	    }

    	    @PutMapping("/withdrawal-requests/{requestId}")
    	    public ResponseEntity<WithdrawalRequest> updateWithdrawalRequest(@PathVariable long requestId, @RequestBody WithdrawalRequest withdrawalRequest) {
    	        WithdrawalRequest updatedRequest = withdrawalRequestService.updateWithdrawalRequest(requestId, withdrawalRequest);
    	        return ResponseEntity.ok(updatedRequest);
    	    }

    	    @DeleteMapping("/withdrawal-requests/{requestId}")
    	    public ResponseEntity<Void> deleteWithdrawalRequest(@PathVariable long requestId) {
    	        withdrawalRequestService.deleteWithdrawalRequest(requestId);
    	        return ResponseEntity.noContent().build();
    	    }

    	    @GetMapping("/withdrawal-requests/{requestId}")
    	    public ResponseEntity<WithdrawalRequest> getWithdrawalRequestById(@PathVariable long requestId) {
    	        WithdrawalRequest withdrawalRequest = withdrawalRequestService.getWithdrawalRequestById(requestId);
    	    ...
    	    public ResponseEntity<List<WithdrawalRequest>> getAllWithdrawalRequests() {
    	        List<WithdrawalRequest> withdrawalRequests = withdrawalRequestService.getAllWithdrawalRequests();
    	        return ResponseEntity.ok(withdrawalRequests);
    	    }

    	    @GetMapping("/withdrawal-requests/status/{status}")
    	    public ResponseEntity<List<WithdrawalRequest>> getWithdrawalRequestsByStatus(@PathVariable String status) {
    	        List<WithdrawalRequest> withdrawalRequests = withdrawalRequestService.getWithdrawalRequestsByStatus(status);
    	        return ResponseEntity.ok(withdrawalRequests);
    	    }
...
//    	    }
    	    ...
    	    public ResponseEntity<PagedResponse<InsuranceSchemeDto>> getAllSchemesByPlanId( 
    	      ...
    	      PagedResponse<InsuranceSchemeDto> schemes = adminService.getAllSchemesByPlanId(planId, page, size, sortBy, direction); 
    	      return new ResponseEntity<>(schemes, HttpStatus.OK); 
    	    }
...
//		return new ResponseEntity<String>(adminService.registerEmployee(employeeRequestDto), HttpStatus.ACCEPTED);
//	}
//
//	@Operation(summary = "Add Agent")
//	@PostMapping("addAgent")
//	public ResponseEntity<String> registerAgent(@RequestBody AgentRequestDto agentRequestDto) {
//		return new ResponseEntity<String>(adminService.registerAgent(agentRequestDto), HttpStatus.ACCEPTED);
//	}
//
//	@GetMapping("/getAllEmployees")
//	public ResponseEntity<PagedResponse<EmployeeResponseDto>> getAllEmployees(
...
//			@RequestParam(name = "direction", defaultValue = "asc") String direction) {
//		System.out.println("To get all cities");
//		return new ResponseEntity<PagedResponse<CityResponse>>(adminService.getAllCities(page, size, sortBy, direction),
//				HttpStatus.OK);
//
//	}
//
...
//	@PutMapping("updateInsuranceScheme/{schemeId}")
//	@Operation(summary = "Update Insurance Scheme")
//	public ResponseEntity<String> updateInsuranceScheme(@PathVariable Long schemeId,
...
//	@PutMapping("updateInsurancePolicy/{policyId}")
//	@Operation(summary = "Update Insurance Policy")
//	public ResponseEntity<String> updateInsurancePolicy(@PathVariable Long policyId,
...
//	@Operation(summary = "Deactivate Insurance Plan by ID")
//	@DeleteMapping("/deactivatePlan/{id}")
//	public ResponseEntity<String> deactivateInsurancePlan(@PathVariable("id") Long id) {
//		logger.info("Deactivating insurance plan with ID: {}", id);
//		boolean isDeactivated = adminService.deactivateInsurancePlan(id);
//
//		if (isDeactivated) {
