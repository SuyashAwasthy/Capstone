...
public class ReportServiceImpl implements ReportService{
	...
	@Override
	public byte[] generateAgentReport(LocalDate startDate, LocalDate endDate) {
		List<Agent> agents = agentRepository.findAgentsByRegistrationDateBetween(startDate, endDate);
